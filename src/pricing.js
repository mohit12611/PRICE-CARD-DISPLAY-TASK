            ...
            <ul className="fa-ul">
             {
                 props.details.listItems.map((item,index) => {
                    ...
                    <li key={index}><span className="fa-li"><FontAwesomeIcon icon={faCheck} /></span>{item.itemName}</li> : 
                    <li key={index} className="text-muted"><span className="fa-li"><FontAwesomeIcon icon={faTimes} /></span>{item.itemName}</li>
                 })
             }
            </ul>
